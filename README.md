...
### 2026-09-26 12:39 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/36218440265
...
- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/35875486106
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：253
- 文件变化统计：3 files changed, 43 insertions(+), 16 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
- 最近未来事件：
  ...
  - 2026-09-25 08:00：📊 [美股] 好市多（Costco，COST）财报发布：2026年8月
  - 2026-09-25 20:30：🔴 [美股] PCE 发布：2026年8月个人消费支出物价
  - 2026-09-25 22:00：🟠 [美股] 密歇根消费者信心与通胀预期：2026年9月终值
  - 2026-09-29 08:00：🟠 [A股] 每月倒数第二个中国营业日：9月

### 2026-09-22 22:19 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/35739343897
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：252
- 文件变化统计：3 files changed, 41 insertions(+), 14 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-09-22 00:09 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/35623751186
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：251
- 文件变化统计：3 files changed, 93 insertions(+), 21 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-09-18 22:03 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/35353803667
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：248
- 文件变化统计：3 files changed, 47 insertions(+), 20 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/35109175008
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：245
- 文件变化统计：3 files changed, 42 insertions(+), 15 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-09-15 22:36 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/34982699184
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：244
- 文件变化统计：3 files changed, 42 insertions(+), 15 deletions(-)
- 变化文件：
...
### 2026-09-15 00:07 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/34866529885
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：243
- 文件变化统计：3 files changed, 12 insertions(+), 12 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/34607518615
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：239
- 文件变化统计：3 files changed, 32 insertions(+), 5 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/34361409276
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：237
- 文件变化统计：3 files changed, 36 insertions(+), 9 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
- 最近未来事件：
  - 2026-09-10 08:00：🟠 [美股] PPI 发布：2026年8月生产者价格指数
  - 2026-09-10 20:30：🟠 [美股] 初请失业金人数：2026-09-10 当周
  - 2026-09-11 08:00：📊 [美股] 甲骨文（Oracle，ORCL）财报发布：2026年8月
  - 2026-09-11 08:00：🔴 [美股] CPI 发布：2026年8月美国通胀数据
  - 2026-09-11 22:00：🟠 [美股] 密歇根消费者信心与通胀预期：2026年9月初值

### 2026-09-08 22:04 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/34235870254
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：236
- 文件变化统计：3 files changed, 33 insertions(+), 6 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-09-07 23:27 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/34138395934
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：235
- 文件变化统计：3 files changed, 170 insertions(+), 4 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-09-05 12:05 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33943594767
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：234
- 文件变化统计：1 file changed, 1 insertion(+), 1 deletion(-)
- 变化文件：
...
### 2026-09-04 21:57 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33880872003
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：234
- 文件变化统计：3 files changed, 227 insertions(+), 34 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-09-04 12:10 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33835716237
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：233
- 文件变化统计：1 file changed, 1 insertion(+), 1 deletion(-)
- 变化文件：
  - 修改：`data/us-megacap-earnings.json`
- 最近未来事件：
  - 2026-09-08 08:00：📊 [美股] 甲骨文（Oracle，ORCL）财报发布：2026年8月
  - 2026-09-10 08:00：🟠 [美股] PPI 发布：2026年8月生产者价格指数
  - 2026-09-10 20:30：🟠 [美股] 初请失业金人数：2026-09-10 当周
  - 2026-09-11 08:00：🔴 [美股] CPI 发布：2026年8月美国通胀数据
  - 2026-09-11 22:00：🟠 [美股] 密歇根消费者信心与通胀预期：2026年9月初值

### 2026-09-03 22:04 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33764618571
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：233
- 文件变化统计：3 files changed, 206 insertions(+), 11 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
- 最近未来事件：
  - 2026-09-04 08:00：🔴 [美股] 非农就业：2026年8月 Employment Situation
  - 2026-09-08 08:00：📊 [美股] 甲骨文（Oracle，ORCL）财报发布：2026年8月
  - 2026-09-10 08:00：🟠 [美股] PPI 发布：2026年8月生产者价格指数
  - 2026-09-10 20:30：🟠 [美股] 初请失业金人数：2026-09-10 当周
  - 2026-09-11 08:00：🔴 [美股] CPI 发布：2026年8月美国通胀数据

### 2026-09-02 22:35 自动更新记录

- 触发来源：local
- Action 记录：本地运行
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：232
- 文件变化统计：2 files changed, 99 insertions(+), 99 deletions(-)
- 变化文件：
  - 修改：`public/calendar/GLOBAL_KEY.ics`
  - 修改：`scripts/risk-calendar/generate-risk-calendar.mjs`
- 最近未来事件：
  - 2026-09-03 08:00：📊 [美股] 博通（Broadcom，AVGO）财报发布：2026年7月
  - 2026-09-03 20:30：🟠 [美股] 初请失业金人数：2026-09-03 当周
  - 2026-09-03 22:00：🟠 [美股] ISM 服务业 PMI：2026年8月
  - 2026-09-04 08:00：🔴 [美股] 非农就业：2026年8月 Employment Situation
  - 2026-09-08 08:00：📊 [美股] 甲骨文（Oracle，ORCL）财报发布：2026年8月

### 2026-09-02 22:30 自动更新记录

- 触发来源：local
- Action 记录：本地运行
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：232
- 文件变化统计：3 files changed, 1314 insertions(+), 12 deletions(-)
- 变化文件：
...
### 2026-09-02 22:01 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33639364481
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：173
- 文件变化统计：3 files changed, 35 insertions(+), 8 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-09-01 22:28 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33519646975
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：172
- 文件变化统计：3 files changed, 35 insertions(+), 8 deletions(-)
- 变化文件：
...
### 2026-09-01 01:21 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33419109422
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：171
- 文件变化统计：3 files changed, 64 insertions(+), 64 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-08-29 14:49 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33239375920
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：170
- 文件变化统计：1 file changed, 1 insertion(+), 1 deletion(-)
- 变化文件：
...
### 2026-08-29 05:04 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33210888242
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：170
- 文件变化统计：3 files changed, 3 insertions(+), 3 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-08-28 22:40 自动更新记录

- 触发来源：workflow_dispatch
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33181305641
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：170
- 文件变化统计：3 files changed, 22 insertions(+), 22 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-08-28 22:39 自动更新记录

- 触发来源：local
- Action 记录：本地运行
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：170
- 文件变化统计：2 files changed, 193 insertions(+)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
- 最近未来事件：
...
### 2026-08-28 19:04 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33165716305
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：169
- 文件变化统计：1 file changed, 1 insertion(+), 1 deletion(-)
- 变化文件：
...
### 2026-08-28 04:06 自动更新记录

- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/33111654233
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：169
- 文件变化统计：3 files changed, 27 insertions(+), 25 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-08-27 20:25 自动更新记录

- 触发来源：local
- Action 记录：本地运行
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：169
- 文件变化统计：2 files changed, 8 insertions(+), 55 deletions(-)
- 变化文件：
  - 修改：`public/calendar/GLOBAL_KEY.ics`
  - 修改：`scripts/risk-calendar/generate-risk-calendar.mjs`
- 最近未来事件：
...
### 2026-08-27 20:15 自动更新记录

- 触发来源：local
- Action 记录：本地运行
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：169
- 文件变化统计：2 files changed, 54 insertions(+), 18 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
- 最近未来事件：
...
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：166
- 文件变化统计：5 files changed, 257 insertions(+), 215 deletions(-)
- 变化文件：
  - 修改：`.github/workflows/update-calendar-feed.yml`
  - 修改：`data/cffex-position-watch.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
  - 修改：`scripts/risk-calendar/generate-risk-calendar.mjs`
  - 修改：`scripts/risk-calendar/update-cffex-followup-review.mjs`
- 最近未来事件：
...
### 2026-08-20 08:44 自动更新记录

- 触发来源：local
- Action 记录：本地运行
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：171
- 文件变化统计：4 files changed, 156 insertions(+), 1320 deletions(-)
- 变化文件：
  - U：`README.backup.md`
  - 修改：`README.backup.md`
  - U：`README.md`
  - 修改：`README.md`
  - U：`data/cffex-position-watch.json`
  - 修改：`data/cffex-position-watch.json`
  - U：`public/calendar/GLOBAL_KEY.ics`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
- 最近未来事件：
  - 2026-08-21 08:00：🟠 [美股] 指数期权 AM-settled 最后交易日提醒：8月 AM-settled 指数期权
  - 2026-08-21 08:00：🟠 [A股] 股指期货/期权月度交割日提醒：8月
...
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：164
- 文件变化统计：5 files changed, 171 insertions(+), 13 deletions(-)
- 变化文件：
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`package.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
  - 修改：`scripts/risk-calendar/update-released-earnings-analysis.mjs`
  - 修改：`tests/us-megacap-earnings-watchlist.test.mjs`
- 最近未来事件：
...
- 触发来源：schedule
- Action 记录：https://github.com/AWENIAI/Financial-Calendar/actions/runs/31169197536
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：163
- 文件变化统计：3 files changed, 234 insertions(+), 10 deletions(-)
- 变化文件：
  - 修改：`data/cffex-position-watch.json`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
...
### 2026-08-07 06:27 自动更新记录

- 触发来源：local
- Action 记录：本地运行
- 订阅文件：`public/calendar/GLOBAL_KEY.ics`
- 当前事件数：162
- 文件变化统计：6 files changed, 463 insertions(+), 96 deletions(-)
- 变化文件：
  - 修改：`README.md`
  - 修改：`data/us-megacap-earnings.json`
  - 修改：`public/calendar/GLOBAL_KEY.ics`
